...
Pour ce dépôt, les dirigeant·e·s de la communauté responsables de l'application sont **Farah et Gilles Maury**.
...
Les cas de comportements abusifs, harcelants ou tout autre comportement inacceptables peuvent être signalés aux dirigeant·e·s de la communauté responsables de l'application du code de conduite **en ouvrant une issue privée sur le dépôt GitHub ou en initiant une discussion privée via GitHub Discussions**. Aucune adresse email n'est maintenue à cet effet, conformément à la posture exposée en sous-section 6.2 du manifeste : tous les échanges relatifs au projet passent par GitHub afin de rester archivés et consultables.
